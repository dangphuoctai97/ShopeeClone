    ...
    <div>
      <div className='flex items-center border-b border-b-gray-200 py-4'>
        ...
        <div className='pl-4'>
          ...
          <Link
            to={path.profile}
            className='flex items-center capitalize text-gray-500 hover:underline hover:text-primaryColor transition-all'
          >
            <svg
            ...
            <span className='text-xs ml-1'>Sửa hồ sơ</span>
          </Link>
        </div>
      </div>
      <div className='mt-7'>
        <NavLink
          to={path.profile}
          className={({ isActive }) =>
            classNames('flex items-center capitalize  transition-colors mb-4', {
              'text-primaryColor': isActive,
              'text-gray-600': !isActive
            })
          }
        >
          <div className='mr-2 size-[22px]'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
