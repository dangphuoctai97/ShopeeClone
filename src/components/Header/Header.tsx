      ...
      <div className='container'>
        ...
        <div className='grid grid-cols-12 gap-4 items-end mt-2'>
          <Link to={path.home} className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-12 lg:h11 fill-white'>
              <g fillRule='evenodd'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='bg-white rounded-sm p-1 flex'>
              ...
              />
              <button className='text-white bg-primaryColor rounded-sm px-6 py-2 flex-shrink-0 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
        ...
        <div className='grid grid-cols-12 gap-4 mt-2'>
          ...
          <div className='col-span-9'>
            <ul className='flex flex-grow gap-3 text-sm text-white font-extralight'>
              <li>
                <Link to='/' className='whitespace-nowrap hover:text-gray-300 '>
                  Quần Jean ống rộng
                </Link>
              </li>
              <li>
